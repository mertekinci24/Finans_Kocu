...
export default function InstallmentProjectionWidget({
  ...
  return (
    <div className="pt-2">
      ...
      {projection.every(p => p.totalAmount === 0) ? (
        <div className="flex flex-col items-center justify-center h-32 gap-2 text-center">
          <span className="text-2xl">📅</span>
          <p className="text-foreground font-black text-xs uppercase tracking-tight">
            Projeksiyon Verisi Yok
          </p>
          <p className="text-muted-foreground text-[10px] leading-relaxed max-w-52">
            Taksit veya düzenli ödeme eklediğinde aylık projeksiyon burada oluşacak.
          </p>
        </div>
      ) : (
