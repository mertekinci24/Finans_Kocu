...
export default function ChatInterface({
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-hidden bg-white rounded-lg shadow-md">
      ...
      <div className="border-t border-neutral-200 bg-neutral-50/50 p-3">
        {selectedFile && (
          <div className="mb-2 flex items-center gap-2 rounded-full bg-blue-50 border border-blue-100 px-3 py-1 text-xs text-blue-700 w-fit max-w-[200px] mx-auto sm:mx-0">
        ...
        <div className="flex items-center gap-2 max-w-4xl mx-auto">
          ...
          <div className="relative">
            <button
              ...
              className={`p-2 rounded-full transition-colors ${
                isAttachmentMenuOpen ? 'bg-neutral-200 text-neutral-900' : 'text-neutral-500 hover:bg-neutral-100'
              }`}
              title="Ekler"
            >
              ...
              {isAttachmentMenuOpen && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-14 left-0 w-48 bg-white shadow-xl rounded-2xl border border-neutral-100 overflow-hidden z-50 py-1"
                  >
                    {[
          ...
          <div className="flex-1 relative flex items-center">
            <input
              ...
              disabled={isLoading}
              className="w-full px-4 py-2.5 bg-white border border-neutral-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all disabled:opacity-50"
            />
          </div>
          ...
          <div className="flex-shrink-0">
            {input.trim() || selectedFile ? (
              <button
                ...
                disabled={isLoading}
                className="p-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-all shadow-md active:scale-95 disabled:opacity-50"
              >
                <svg
